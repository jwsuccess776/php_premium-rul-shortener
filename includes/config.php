...
// Database Configuration
  $dbinfo = array(
    ...
    "db" => 'phpthemechage',            // The database where you have dumped the included sql file
  ...
  $config = array(
     ...
     *    fail.
     *
     *  - If the two config below don't have any values or have PUS721884708856a1b9b60f770bbb79e790c600b4b49faa3a2a165242e90ca21ac3 or 33b78db25493af814ff4c028a639c8d7, replace these by a random key.
     ====================================================================================
    */
    "security" => 'PUS721884708856a1b9b60f770bbb79e790c600b4b49faa3a2a165242e90ca21ac3',  // !!!! DON'T CHANGE THIS IF YOUR SITE IS LIVE !!!!
    "public_token" => '33b78db25493af814ff4c028a639c8d7', // This is randomly generated and it is a public key
